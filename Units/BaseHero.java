...
public abstract class BaseHero implements BaseInterface {
    ...
    public BaseHero(ArrayList<BaseHero> teamList, String name, String role, String icon, int attack, int defence,
                    int[] damage, int health, int speed, int x, int y, String team, boolean status) {
    ...
    public String getInfo() {
        return String.format("%-10s %-13s%-3s %s: %-3d/ %-3d %s: %-5d |", name, role, icon, "\uD83E\uDDE1",
